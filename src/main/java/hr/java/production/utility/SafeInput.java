...
import hr.java.production.exception.InputPredicateException;
...
/**
 * Pomoćna klasa za siguran i garantiran unos točnih podataka.
 */
public class SafeInput {
    private static final Logger logger = LoggerFactory.getLogger(SafeInput.class);
